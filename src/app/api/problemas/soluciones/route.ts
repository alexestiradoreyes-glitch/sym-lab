...
import { guardarSolucion, leerSoluciones, eliminarSolucion } from '@/lib/problemas'
...
export async function DELETE(request: NextRequest) {
  ...
  try {
    await eliminarSolucion(id)
    return NextResponse.json({ ok: true })
  } catch (error) {
    console.error('[SYM LAB] Error eliminando solución:', error)
